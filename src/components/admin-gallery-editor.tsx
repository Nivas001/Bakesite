...
const PRESET_BAKERY_PHOTOS = [
  ...
  { label: "Salted Caramel Cupcake", image: "/about/salted-caramel-cupcake.webp" },
  { label: "Royal Gilded Brownie", image: "/cakes/royal-gold-brownie.webp" },
  { label: "Dark Belgian Truffle Cake", image: "/cakes/belgian-truffle-cake.webp" },
  { label: "Biscoff Herringbone Cake", image: "/cakes/biscoff-herringbone-cake.webp" },
  { label: "Pink Bento Cake", image: "/cakes/pink-bento-cake.webp" },
  ...
  { label: "Walnut Cupcake Trio", image: "/about/walnut-cupcake-trio.webp" },
