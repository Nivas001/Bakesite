...
export function ScrollToTop() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-18 right-4 z-50 flex size-10 md:bottom-6 items-center justify-center rounded-full bg-card/90 border border-border/80 shadow-lift backdrop-blur-md text-cocoa transition-all duration-300 hover:bg-berry hover:text-berry-foreground hover:border-berry/50 hover:scale-110 active:scale-95 cursor-pointer ${
        visible
