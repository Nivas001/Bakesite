      ...
      <div className="flex flex-col justify-between gap-6 md:flex-row md:items-start sm:gap-8">
        <div className="flex flex-col gap-1.5 sm:gap-2 flex-1">
          ...
          <p className="max-w-xl text-xs sm:text-base text-muted-foreground leading-relaxed">
            A rotating handful of fresh morning bakes at a friendlier price, plus exclusive checkout
            coupon codes.
          </p>
        </div>
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1 h-7 rounded-full px-3 text-[11px] font-semibold transition-all duration-200 cursor-pointer active:scale-95 ${
                          isCopied
                            ...
                            : "bg-berry/10 text-berry-deep hover:bg-berry hover:text-berry-foreground shadow-2xs"
                        }`}
                      >
                        {isCopied ? (
                          <>
      ...
      <section>
        ...
        {offers.length === 0 ? (
          <div className="glass-panel flex flex-col items-center justify-center rounded-2xl p-8 text-center border border-border/70">
            <div className="flex size-12 items-center justify-center rounded-2xl bg-secondary text-berry-deep mb-3">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-3 mb-5 sm:mb-6">
          <div>
            ...
            <p className="mt-1 text-xs sm:text-sm text-muted-foreground max-w-xl">
              Hover and drift through every single small-batch cake, pastry, cookie, and seasonal
              treat in our kitchen. Click any tile to inspect or order.
            </p>
          </div>

          <Button
            asChild
            className="rounded-full bg-berry text-berry-foreground hover:bg-berry/90 shadow-soft w-fit"
          >
            <Link to="/shop">
